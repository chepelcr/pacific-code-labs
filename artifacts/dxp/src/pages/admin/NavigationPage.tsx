    ...
    <div data-testid="navigation-page">
      ...
      <div className="space-y-4">
        <BilingualSection title="Enlaces de navegación">
          {items.map((item, idx) => (
            <div key={idx} className="flex items-start gap-3 pb-3 border-b border-[#F1F5F9] last:border-0 last:pb-0" data-testid={`nav-item-${idx}`}>
              <GripVertical className="w-4 h-4 text-[#CBD5E1] flex-shrink-0 mt-8" />
              ...
              <button onClick={() => removeItem(idx)} className="text-[#94A3B8] hover:text-red-500 flex-shrink-0 mt-8">
